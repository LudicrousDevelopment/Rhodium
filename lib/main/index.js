...
$Rhodium.Location = function(url, window = _window) {
  ...
  console.log($Rhodium.location.href)
...
Object.defineProperty(window.document, 'cookie', {
  ...
  set(val) {
    ...
    //val.split('=').map((e,i)=>console.log(i))
...
window.History.prototype.pushState = new Proxy(window.History.prototype.pushState, {
  apply(t, g, a) {
    ...
    Reflect.apply(t, g, a)
    console.log($Rhodium.Location, $Rhodium.url)
...
window.fetch = new Proxy(window.fetch, {
  apply(t, g, a) {
    if (typeof a[0]=='object') {a[0].url = $Rhodium.url.encode(a[0].url, {Url: new URL($RConfig.url)});return Reflect.apply(t, g, a)}
