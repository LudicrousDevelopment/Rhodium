...
const uagent = Object.getOwnPropertyDescriptor(window.navigator.userAgent)

Object.defineProperty(window.navigator, 'userAgent', {
  get() {
    return $Rhodium.userAgent || uagent.get.call(this)
  }, 
  set() {
        ...
        Object.defineProperty(element.prototype, property, {
          get: descriptor ? new Proxy(descriptor.get, {
              apply: (target, that, args) => {
                  ...
                  try {
                    if (property=='contentWindow') val.History.prototype.replaceState = $Rhodium.History().replaceState;
                    if (property=='src'||property=='href'||property=='action') {
                      return val.getAttribute(property)
                    } 
                  } catch(e) {};
                  return val;
              }, 
